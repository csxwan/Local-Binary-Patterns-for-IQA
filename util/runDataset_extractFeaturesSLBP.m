function runDataset_extractFeaturesSLBP( datasetNames, featureInfo )
...
for idx_dataset = 1:numel( datasetNames )
    ...
    for idx_opts = 1:numel( featureOptsAll )
        ...
        if exist( saveFeaturesPath, 'file' )
            ...
            [ features_ref, features_dist ] = getFeaturesSLBP( featureFcn, featureOpts, img_path_ref, img_path_dist );
