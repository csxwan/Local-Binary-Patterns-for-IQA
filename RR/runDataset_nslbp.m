...
featureFcnPath = genpath( 'feature/NSLBP' );
% featureType = 'LBP_DBC_SCHARR';
% featureFcn = @(img, opts) lbp_dbc_scharr( opts.dim_mfs, opts.radius, opts.n_sampling, img );
featureType = 'NSLBP_INT';
featureFcn = @(img, opts) nslbp_int(opts.radius, opts.n_sampling, img );
