...
featureFcnPath = genpath( 'feature/LBP_IMG' );
% featureType = 'LBP_DBC_SCHARR';
% featureFcn = @(img, opts) lbp_dbc_scharr( opts.dim_mfs, opts.radius, opts.n_sampling, img );
featureType = 'LBP_IMG_INT';
featureFcn = @(img, opts)lbp_img_int(opts.radius, opts.n_sampling, img );
...
scoreOptsAll = { scoreOpts_L0 , scoreOpts_L1};
