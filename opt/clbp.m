function [result] = clbp(radius,neighbors,I)
mapping=getmapping(neighbors,'u2'); 
[CLBP_S,CLBP_M,CLBP_C] = clbp2(I,radius,neighbors,mapping,'x');
    ...
    Hist3D = hist3(CLBP_SM,[mapping.num,mapping.num]);
...
function [CLBP_S,CLBP_M,CLBP_C] = clbp2(varargin) % image,radius,neighbors,mapping,mode)
% Version 0.2
